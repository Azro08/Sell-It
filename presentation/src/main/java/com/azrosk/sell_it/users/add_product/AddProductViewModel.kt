...
class AddProductViewModel @Inject constructor(
    ...
    private val _imageUploaded = MutableStateFlow<ScreenState<List<String>?>>(ScreenState.Loading())
    val imageUploaded: MutableStateFlow<ScreenState<List<String>?>> = _imageUploaded
